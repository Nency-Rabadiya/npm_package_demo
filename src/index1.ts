...
const unUsed = (id: number) => {
  let car: string = "bmw";
  console.log(car, id); //if we do not use any of them
};
unUsed(5);
...
switch (a) {
  case 0:
    console.log("even");
    break; //if remove this then give warning
  case 1:
    console.log("odd");
    break;
}
...
function fn(s: string) {
  //'s' implicitly has 'any' type if we do not define any type to "s"
  console.log(s);
}
